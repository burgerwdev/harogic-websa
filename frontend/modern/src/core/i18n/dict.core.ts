...
export const en = {
	...
	"device_disconnected_short": "DEVICE DISCONNECTED",
	"device_disconnected_hint": "The analyzer is not answering on USB. Check the cable; the page reconnects and resumes automatically.",
	"volume": "Volume",
	...
	"auto_scale": "Fit the reference to the trace (once)",
	"auto_scale_ok": "Reference already fits",
	"auto_scale_no_signal": "No signal to fit",
	"auto_scale_no_data": "Waiting for a trace",
	...
	"ref_limited": "Device limited Ref to {ref} dBm",
	...
	"tip_input-ref": "Swept/RTA: top of the display scale. SDR/VSA: the IQS input gain (RefLevel_dBm) - measured linear to about -20 dBm at 0 dBm, and -15 dBm then reads 3.9 dB low, so raise it until the trace sits well inside the window.",
	"tip_btn-ref-set": "Apply the reference level to the device",
	"tip_btn-ref-auto": "Fit the reference level to the trace, once",
...
export const zh = {
	...
	"device_disconnected_short": "设备已断开",
	"device_disconnected_hint": "频谱仪 USB 连接已丢失。请检查线缆，页面会自动重连并恢复。",
	"volume": "音量",
	"squelch_short": "静噪",
	"capture_bw": "IQ 捕获带宽",
	"agc_tip": "音频 AGC",
	...
	"auto_scale": "按当前迹线调整参考电平（一次）",
	"auto_scale_ok": "参考电平已合适",
	"auto_scale_no_signal": "没有可对齐的信号",
	"auto_scale_no_data": "等待迹线",
	...
	"ref_limited": "设备将 Ref 限制为 {ref} dBm",
	...
	"tip_input-ref": "扫频/RTA:显示刻度顶值。SDR/VSA:IQS 输入增益(RefLevel_dBm)—— 实测 0 dBm 时线性到约 −20 dBm,而 −15 dBm 会低读 3.9 dB,所以把它抬到迹线稳稳落在窗内为止。",
	"tip_btn-ref-set": "将参考电平下发设备",
	"tip_btn-ref-auto": "按当前迹线自动调整一次参考电平",
