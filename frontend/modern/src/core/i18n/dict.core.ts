...
export const en = {
	...
	"ui_scale": "UI:",
	"ui_scale_auto": "Auto",
	"tip_ui_scale": "Global UI scale: sizes the fonts, the spacing and the canvas together. Auto follows the screen height.",
	"frequency": "Frequency",
	"center": "Center",
	"span": "Span",
	"start": "Start",
...
export const zh = {
	...
	"ui_scale": "界面:",
	"ui_scale_auto": "自动",
	"tip_ui_scale": "全局界面缩放:字号、间距与画布一起缩放;自动档跟随屏幕高度。",
	"frequency": "频率",
	"center": "中心频率",
	"span": "扫宽",
	"start": "起始",
